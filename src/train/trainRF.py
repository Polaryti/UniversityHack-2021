...
if __name__ == "__main__":
    ...
    for estimators in [2000,5000,10000]:
        reg = RandomForestRegressor(random_state=42,verbose=0, n_jobs=-1, n_estimators=estimators, min_samples_split=3, min_samples_leaf=2)
        ...
        filename = 'model_RF'+str(estimators) + '.sav'
